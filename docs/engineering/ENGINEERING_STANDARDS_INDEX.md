...
| [Engineering Findings Lifecycle](./ENGINEERING_FINDINGS_LIFECYCLE.md) | v0.1 | Draft Methodology | Quality | Distinguishes engineering findings from software defects and defines a standards-based review lifecycle for quality improvement work. | This repository; future Aredir Labs projects |
